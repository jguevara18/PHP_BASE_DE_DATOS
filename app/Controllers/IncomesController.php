...
class IncomesController {
    ...
    public function store($data) {
        ...
        $stmt = $this->connection->prepare("INSERT INTO incomes (payment_method, type, date, amount, description) VALUES (:payment_method, :type,:date,
        :amount, :description)");
        ...
        header("location:incomes"); //redireccion
    ...
    public function destroy($id) {
        ...
        $sure = readline("de verdad quiere eliminar el registro?");
        if ($sure == "no")
